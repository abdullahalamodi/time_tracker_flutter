...
class SignInPage extends StatelessWidget {
  ...
  static Widget create(BuildContext context) {
    ...
    return Provider<SignInBloc>(
      ...
      child: Consumer<SignInBloc>(
          builder: (_, bloc, __) => SignInPage(signInBloc: bloc)),
      dispose: (_, bloc) => bloc.despose(),
    );
  }
  ...
  Future<void> _signInAnonymously(BuildContext context) async {
    try {
      ...
      signInBloc.showSignInError(context, e);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: Provider.of<SignInBloc>(context).isLoodingStream,
          initialData: false,
          builder: (context, snabshot) =>
              _buildContent(context, snabshot.data)),
